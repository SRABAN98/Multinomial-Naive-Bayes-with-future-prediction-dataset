...
y_pred_MultinomialNB = pd.DataFrame()

d2["y_pred_MultinomialNB"] = classifier.predict(M)


#save the future prediction dataframe as the .csv file format
d2.to_csv("FPofMultinomialNBAlgo.csv")
